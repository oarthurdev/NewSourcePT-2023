...
public:
	...
	void DrawThreeLineMessage(int x, int y, char* message1, char* message2, char* message3, DWORD color1 = RGB(0, 0, 0), DWORD color2 = RGB(0, 0, 0), DWORD color3 = RGB(0, 0, 0), LPDIRECT3DTEXTURE9 clanMark = NULL, BOOL selected = FALSE, int bellaMarkIndex = -1);

	void DrawFourLineMessage(int x, int y, char* message1, char* message2, char* message3, char* message4, DWORD color1 = RGB(0, 0, 0), DWORD color2 = RGB(0, 0, 0), DWORD color3 = RGB(0, 0, 0), DWORD color4 = RGB(0, 0, 0), LPDIRECT3DTEXTURE9 clanMark = NULL, BOOL selected = FALSE, int bellaMarkIndex = -1);
	...
	void DrawClanMark1(LPDIRECT3DTEXTURE9 clanMark, char* clanName, int x, int y, BOOL frameFlag = FALSE);
	...
	char	textdata[12][64];
	POINT	textsize;
	int textarrange(const std::string& text, bool clanm);
