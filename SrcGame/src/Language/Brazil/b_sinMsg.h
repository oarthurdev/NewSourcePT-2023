...
sMESSAGEBOX	sMessageBox[100] = {
	...
	{"Aguarde para poder utilizar novamente"},
	...
	{"O processo falhou"},
	{"O processo falhou"},
	{"Esse item não pode ser usado"},
	{"Esse item não pode ser usado"},
	{"Esse item não pode ser usado"},
	{"Esse item não pode ser usado"},
	{"Esse item não pode ser usado"},
	{"Seus itens já estão maturados"},
	{"Suas Habilidades já estão treinadas"},
	{"O processo de maturação foi concluído com sucesso"},
	{"As habilidades foram treinadas com sucesso"}, //83
	{"Você já usou esse item 5 vezes"},
	{"Peso Máximo aumentado com sucesso"},
	{"Este item não pode ser Limpo"},
	{"Coloque um item primeiro"},
	{"Retire os itens primeiro"},
	{"O processo de limpeza falhou"},
...
sMESSAGEBOX2 sMessageBox2[20] = {
	...
	{"Quanto coin"," você deseja trocar?"},
};
...
sMESSAGEBOX3 sMessageBox3[MESSAGE3_MAX] = {
	...
	{"",""},
	{"",""},
	{"Finalize até o nível máximo","estipulado ou ira perde-la!"},
	{"Deseja realmente","CANCELAR o desafio?"},
	{"Deseja entrar","no Hell's Gate?"},
};
...
"Res. Orgânica:  \r",
"Nature Type:  \r",
"Resistencia a Fogo:  \r",
"Resistencia a Gelo:  \r",
"Resistencia a Raio:  \r",
"Resistencia a Veneno: \r",
"Water Type:  \r",
"Wind Type:  \r",
"HP Regen:  \r",
"MP Regen: \r",
...
"R. Gelo Adicional:  \r",
"R. Raio Adicional:\r",
"R. Veneno Adicional:  \r",
"R. Água Adicional:  \r",
"R. Vento Adicional:  \r",
"P. de ATQ Adicional:  \r",
"Taxa de ATQ ad.:  \r",
"Spec. RNG:\r",
"ATQ Org. Adicional:  \r",
"Spec. Nature ATK:  \r",
"ATQ Fogo Adicional\r",
"ATQ Gelo Adicional:  \r",
"ATQ Raio Adicional:  \r",
"ATQ Veneno Adicional:  \r",
"ATQ Água Adicional:  \r",
"ATQ Vento Adicional:  \r",
"Bônus Vida:  \r",
"Bônus Mana:  \r",
"Regen de Vida:  \r",
"Regen de Mana:  \r",
...
char* SpecialName3 = "Especialização: %s\r";
...
char* CountinueTime = "Tempo restante: \r";
...
char* UseStaminaName = "Custo de RES:\r";
...
char* IncreLifePercent3 = "Adicional HP:\r"; //Rubinho HP AS
...
char* BuyMyShopItem7 = "%s comprou %d %s por %d";
char* BuyMyShopItem8 = "%s lhe vendeu %d %s por %d";
...
char* PremiumItemDoc[][2] = {
	...
	{"Aumento de 5% no Crítico.\r" ,"Não usado com Perg. da Caça.\r"},
	{"Aumento de 5% na Esquiva.\r" ,"Não usado com Perg. de Dion.\r"},
};
...
char* UpKeepItemDoc[] = {
	...
	"Exp. %d%s adicional",
	"Ataque 10%% adicional",
	"Converte dano em Vida",
	"Converte dano em Mana",
	"Aumenta a capacidade em 1000",
	"Reduz o uso de Mana",
	"^_^",
	"^_^",
	"^_^",
	"^_^",
	"^_^",
	"Reduz o uso de Estamina",
	"Ataque adicional: 10%% ",
	"Crítico adicional: 5%% ",
	"Esquiva adicional: 5%% ",
	"Vida adicional: 10%% ",
	"Mana adicional: 10%% ",
	"Estamina adicional: 10%% ",
	"Converte dano em Estamina ",
	"Adicional de Mov.Speed",
	"Dano Ataque adicional: +%d",
	"Ataque adicional: +%d%%",
};
char* UpKeepItemName[] = {
	"Olho Mágico",
