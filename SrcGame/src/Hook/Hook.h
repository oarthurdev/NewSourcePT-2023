...
typedef BOOL(WINAPI *H_GetTextExtentPoint32)(HDC hdc, LPCTSTR lpString, int c, LPSIZE lpSize);
H_GetTextExtentPoint32 _GetTextExtentPoint32;
...
typedef COLORREF(WINAPI *H_SetTextColor)(HDC hdc, COLORREF crColor);
H_SetTextColor _SetTextColor;
