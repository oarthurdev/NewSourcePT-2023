...
char szFieldDirectory[64] = { 0 };
char szMapDirectory[64] = { 0 };
char szTitleDirectory[64] = { 0 };
...
int InitField()
{
	...
	//passagem para caverna dos cogumelos
	...
	sField[cnt].AddWarpOutGate(&sField[46], -11975, -62457, 173);
	sField[cnt].WarpGate[sField[cnt].WarpGateActiveNum].LimitLevel = 118;


	sField[cnt].AddWarpGate(36128, -2162, 804, 64, 32);
	sField[cnt].AddWarpOutGate(&sField[cnt + 11], -11088, -41570, 343);
	//passagem para templo maldito primeiro andar
	sField[cnt].WarpGate[sField[cnt].WarpGateActiveNum].LimitLevel = 70;
	...
	sField[cnt].AddWarpGate(35400, 31863, 820, 64, 32);
	sField[cnt].AddWarpOutGate(&sField[44], 18006, -34740, 216);
	sField[cnt].WarpGate[sField[cnt].WarpGateActiveNum].LimitLevel = 114;
...
#define	OUT_Y	830
	...
	sField[cnt].WarpGate[sField[cnt].WarpGateActiveNum].LimitLevel = 130;




	cnt = 49;
	sField[cnt].SetName("mar\\ruin-arenaSF.ASE", "mar");
	sField[cnt].State = FIELD_STATE_FOREST;
	sField[cnt].BackImageCode[0] = FIELD_BACKIMAGE_DAY;
	sField[cnt].BackImageCode[1] = FIELD_BACKIMAGE_GLOWDAY;
	sField[cnt].BackImageCode[2] = FIELD_BACKIMAGE_NIGHT;
	sField[cnt].BackMusicCode = BGM_CODE_FOREST;
	sField[cnt].ServerCode = PLAY_SERVER_CODE_EXTEND;
	sField[cnt].SetCenterPos(-45533, -23565);
	sField[cnt].AddStartPoint(-45533, -23565);
	...
	sField[cnt].SetCenterPos(28700, -74000);
	sField[cnt].AddStartPoint(28700, -74000);
	sField[cnt].AddWarpGate(27898, -75583, 1695, 64, 32);
	sField[cnt].AddWarpOutGate(&sField[36], 33013, 52779, 1281);
