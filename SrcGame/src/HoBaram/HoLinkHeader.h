...
extern SocketData *ConnectServer_Main();
...
extern int DrawFourLineMessage(int x, int y, char* messageOne, char* messageTwo, char* messageThree, char* messageFour, DWORD color1, DWORD color2, DWORD color3, DWORD color4, LPDIRECT3DTEXTURE9 clanMark = NULL, BOOL selected = FALSE, int bellaMarkIndex = -1);
