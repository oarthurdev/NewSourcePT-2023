...
snFIND_EFFECT	snFindEffects[snFIND_EFFECT_MAX] = {
	...
	{ "game\\Audio\\Effects\\player\\Assassin\\"		,	snCHAR_SOUND_ASSASSINE },
	...
	{ "game\\Audio\\Effects\\player\\Shaman\\"		,	snCHAR_SOUND_SHAMAN     },
...
int PlayBGM_Direct(int MusicNum)
{
	...
	if (SETTINGSHANDLER->hasSound() && MusicNum >= 0)
	{
