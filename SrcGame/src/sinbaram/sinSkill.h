...
#define HIGH_LEVEL_MERIT_SKILL			(GROUP_OTHERSKILL | CHANGE_JOB4 | SKILL_9)
#define BUFF_WARMODE		(GROUP_OTHERSKILL | CHANGE_JOB4 | SKILL_10)
#define PLAYER_VIP   		(GROUP_OTHERSKILL | CHANGE_JOB4 | SKILL_11)
...
#define ELIXIR_IRA        (GROUP_OTHERSKILL | CHANGE_JOB4 | SKILL_15)
#define ELIXIR_GLORIA        (GROUP_OTHERSKILL | CHANGE_JOB4 | SKILL_16)

#define BC_SKILL_SILVER        (GROUP_OTHERSKILL | CHANGE_JOB1 | SKILL_15)
#define BC_SKILL_BRONZE        (GROUP_OTHERSKILL | CHANGE_JOB1 | SKILL_16)

#define PLAYERVIP			(GROUP_OTHERSKILL | CHANGE_JOB4 | SKILL_17)

#define DELAY_GLOBAL   		(GROUP_OTHERSKILL | CHANGE_JOB4 | SKILL_15)
struct sSKILL_INFO
{
	char SkillName[64];
	char SkillDoc[150];
