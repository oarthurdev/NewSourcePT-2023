...
int SendCoinShop(SocketData *lpsmSock);

int SendRestaureItem(SocketData *lpsmSock);

int SendRanking(SocketData* lpsmSock);

int SendOpenMixtureItemReset(SocketData *lpsmSock);

int SendOpenBattleEvent(SocketData* lpsmSock);

int SendOpenBattleArena(SocketData *lpsmSock);
...
int SetMixItem(sITEMINFO* pItem, int MixNum);//Rubinho
