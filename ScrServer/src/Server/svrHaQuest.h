...
case HAQUEST_CODE_ELEMENTARY_A:
	...
	if (lpTransCommand->LParam == 2)
	{
		...
		case JOBCODE_PRIESTESS:
			dwItemCode = sinCA2 | sin02;
			break;

		case JOBCODE_MAGICIAN:
			dwItemCode = sinCA2 | sin01;
			break;
...
case HAQUEST_CODE_ELEMENTARY_B:
	if (lpTransCommand->LParam == 2)
	{
		rsPutItem(lpPlayInfo, sinBI1 | sin24, lpPlayInfo->smCharInfo.JOB_CODE);
		rsPutItem(lpPlayInfo, sinBI1 | sin14, lpPlayInfo->smCharInfo.JOB_CODE);
...
case HAQUEST_CODE_ELEMENTARY_C:
	...
	if (lpTransCommand->LParam == 2)
	{
		rsPutItem(lpPlayInfo, sinGB1 | sin02, 1);
		//rsPutItem(lpPlayInfo, sinGB1 | sin02, 1);
		//rsPutItem(lpPlayInfo, sinPM1 | sin01, 10);
...
case HAQUEST_CODE_ELEMENTARY_D:
	if (lpTransCommand->LParam == 2)
	{
		rsPutItem(lpPlayInfo, sinOA1 | sin07, lpPlayInfo->smCharInfo.JOB_CODE);
		rsPutItem(lpPlayInfo, sinOR1 | sin07, lpPlayInfo->smCharInfo.JOB_CODE);
		rsPutItem(lpPlayInfo, sinOR1 | sin07, lpPlayInfo->smCharInfo.JOB_CODE);
	}
#ifdef	_BEGINNER_EVENT
	if (lpTransCommand->LParam == 2)
	{
		...
		{
		case JOBCODE_MECHANICIAN:
			dwItemCode = sinWC1 | sin07;

			break;
		case JOBCODE_FIGHTER:
			dwItemCode = sinWA1 | sin07;

			break;
		case JOBCODE_PIKEMAN:
			dwItemCode = sinWP1 | sin07;

			break;
		case JOBCODE_ARCHER:
			dwItemCode = sinWS1 | sin07;

			break;
		case JOBCODE_KNIGHT:
			dwItemCode = sinWS2 | sin07;

			break;
		case JOBCODE_ATALANTA:
			dwItemCode = sinWT1 | sin07;

			break;
		case JOBCODE_PRIESTESS:
			dwItemCode = sinWM1 | sin07;
		...
		case JOBCODE_MAGICIAN:
			...
			break;
		case JOBCODE_ASSASSINE:
			dwItemCode = sinWD1 | sin07;
			break;
		case JOBCODE_SHAMAN:
			dwItemCode = sinWN1 | sin07;
			break;
...
case HAQUEST_CODE_ELEMENTARY_E:
	if (lpTransCommand->LParam == 2)
	{
		rsPutItem(lpPlayInfo, sinFO1 | sin07);
		rsPutItem(lpPlayInfo, sinFO1 | sin07);
#ifdef _BEGINNER_EVENT
		rsPutItem(lpPlayInfo, sinGP1 | sin17);
		rsPutItem(lpPlayInfo, sinGP1 | sin17);
...
case HAQUEST_CODE_ELEMENTARY_G:
	if (lpTransCommand->LParam == 2)
	{
		rsPutItem(lpPlayInfo, sinFO1 | sin08);
		rsPutItem(lpPlayInfo, sinFO1 | sin08);
