...
int ForceOrbUseLevel[][2] = {
	{ 1, 19 }, { 1, 29 }, { 1, 39 }, { 1, 49 }, { 50, 200 }, { 50, 200 }, { 50, 200 }, { 50, 200 }, { 50, 200 }, { 50, 200 }, { 50, 200 }, { 50, 200 }, { 50, 200 }, { 50, 200 },
};
	...
	for(int i = 0; i < 10; i++)
	{
		if(ContinueSkill[i].Flag)
		{
			...
			case SKILL_SPIRIT_ELEMENTAL:
				...
				break;
				//sinfRegenMana += Spirit_Elemental_RegenMana[ContinueSkill[i].Point - 1];
				//sinTempDamage2[0] += (int)(sinChar->Attack_Damage[0] * Spirit_Elemental_Damage[ContinueSkill[i].Point - 1]) / 100.0f;
				//sinTempDamage2[1] += (int)(sinChar->Attack_Damage[1] * Spirit_Elemental_Damage[ContinueSkill[i].Point - 1]) / 100.0f;
