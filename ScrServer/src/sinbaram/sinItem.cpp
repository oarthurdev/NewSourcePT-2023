...
int cITEM::ShowItemInfo(sITEM *pItem, int Flag, int Index)
{
	...
	if (pItem->sItemInfo.CODE == (sinCA1 | sin01) || pItem->sItemInfo.CODE == (sinCA1 | sin02) ||
		...
		pItem->sItemInfo.CODE == (sinDB1 | sin33) || pItem->sItemInfo.CODE == (sinDS1 | sin33) ||
		pItem->sItemInfo.CODE == (sinOA2 | sin32) || pItem->sItemInfo.CODE == (sinOR2 | sin50) ||
		pItem->sItemInfo.CODE == (sinOR2 | sin53) || pItem->sItemInfo.CODE == (sinOA1 | sin50) ||
