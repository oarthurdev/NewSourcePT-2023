...
int main(int argv, char* argc[])
{
	...
	SetConsoleTitle("Priston Tale - Servidor");
	...
	CreateSQLConnection(DATABASEID_CoinShopDB);
	cout << "Conectado com sucesso" << endl;

	cout << "Conectando-se ao Banco de Dados: StartUserDB" << endl; //Rubinho
	CreateSQLConnection(DATABASEID_StartUserDB);
	cout << "Conectado com sucesso" << endl;

	cout << "Conectando-se ao Banco de Dados: BattleEventsDB" << endl;
