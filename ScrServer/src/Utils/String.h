...
int STRCMP(const char* lhs, const int lhs_size, const char* rhs, const int rhs_size, bool case_sensitive = true);
...
void STRCAT(char* dest, const int dest_capacity, const char* src);
